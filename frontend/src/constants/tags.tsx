import { FireIcon, GhostIcon, HandshakeIcon, HeartBreakIcon, MaskSadIcon, MoonStarsIcon, PopcornIcon, QuestionIcon, SmileyAngryIcon, SmileyMehIcon, SunglassesIcon, ToiletIcon, WineIcon } from "@phosphor-icons/react";
