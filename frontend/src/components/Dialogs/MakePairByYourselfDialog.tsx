...
const MakePairByYourselfDialog = ({ open, onClose, ownerProfileId }: DialogProps & { ownerProfileId: string }) => {
    ...
    return (
        <NBModal
            ...
            onClose={handleClose}
            children={
                <Stack component="form" onSubmit={handleSubmit} direction="column" gap="16px">
                    <Typography variant="headingLarge">At least tell us your partner’s name!</Typography>
                    <Stack direction="column" gap="12px">
                        <Typography variant="bodyMedium">
                            If your partner doesn’t want to download the app or maybe they are just too lazy to do it, you can create a pair managed by yourself.
                        </Typography>
                        <Typography variant="bodyMedium">
                            You will be able to add ratings, comments and other things for both of you. Your partner will be able to join your pair if they ever change their mind.
                        </Typography>
                        <Stack>
