...
const CustomIconButtonBase = styled(ButtonBase)<{ color?: CustomColorOptions }>(
	({ theme, color }) => {
		const bodyColor = color
			? (theme.palette[color] as CommonColors)
...
const BottomLayer = styled(motion.div)<{ color?: CustomColorOptions }>(
	({ theme, color }) => {
...
const NBIconButton: React.FC<NBIconButtonProps> = ({
	loading,
	color,
	icon,
	disabled,
